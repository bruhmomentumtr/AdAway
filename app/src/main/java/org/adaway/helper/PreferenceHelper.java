...
public final class PreferenceHelper {
        ...
        public static void setDisplayTelemetryConsent(Context context, boolean displayTelemetryConsent) {
                SharedPreferences prefs = context.getSharedPreferences(
                                ...
                                Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = prefs.edit();
                editor.putBoolean(context.getString(R.string.pref_display_telemetry_consent_key),
        ...
        public static void setVpnExcludedApps(Context context, Set<String> excludedApplicationPackageNames) {
                SharedPreferences prefs = context.getSharedPreferences(
                                ...
                                Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = prefs.edit();
                editor.putStringSet(context.getString(R.string.pref_vpn_excluded_user_apps_key),
                                excludedApplicationPackageNames);
                editor.apply();
        }

        public static int getRecentLogsRefreshInterval(Context context) {
                SharedPreferences prefs = context.getSharedPreferences(
                                Constants.PREFS_NAME,
                                Context.MODE_PRIVATE);
                return prefs.getInt(
                                context.getString(R.string.pref_recent_logs_refresh_interval_key),
                                context.getResources().getInteger(R.integer.pref_recent_logs_refresh_interval_def));
        }
}
